...
public class VEnvironment {
    ...
    public static File getVirtualStorageBaseDir() {
        ...
        VLog.d("gctech","externalFilesRoot:"+externalFilesRoot.getAbsolutePath());
        if (externalFilesRoot != null) {
            File vBaseDir = new File(externalFilesRoot, "gcduomi");
            File vSdcard = new File(vBaseDir, "vsdcard");
            VLog.d("gctech","fir:"+vBaseDir.getAbsolutePath()+",vSdcard:"+vSdcard.getAbsolutePath());
...
//        return ensureCreated(new File("/sdcard", "system"));
    }
