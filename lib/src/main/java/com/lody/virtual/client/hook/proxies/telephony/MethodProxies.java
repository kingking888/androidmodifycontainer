...
//        @Override
//        public Object call(Object who, Method method, Object... args) throws Throwable {
//            VLog.d("gctech","GetDeviceId:"+getDeviceInfo().deviceId);
//            return getDeviceInfo().deviceId;
//        }
//
//    }
...
//
    ...
    static class GetSubscriptionCarrierId extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            VLog.d("gctect","getSubscriptionCarrierId:"+getDeviceInfo().simOperator);
...
//
    ...
    static class GetSubscriptionCarrierName extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            VLog.d("gctect","getSubscriptionCarrierName:"+getDeviceInfo().simOperatorName);
