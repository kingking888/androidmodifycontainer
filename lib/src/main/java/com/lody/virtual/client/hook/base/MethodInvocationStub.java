...
public class MethodInvocationStub<T> {
    ...
    public MethodInvocationStub(T baseInterface, Class<?>... proxyInterfaces) {
        ...
        if (baseInterface != null) {
            ...
            VLog.d("gctect", "create proxy:"+mBaseInterface.toString());
        } else {
            VLog.d(TAG, "Unable to build HookDelegate: %s.", baseInterface);
        }
    }
...
//            VLog.w(TAG, "addMethodProxy(%s,%s) sucess.", methodProxy.getMethodName(),
//                    methodProxy.getClass().getName());
    ...
    private class HookInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if(method.getName().equals("getString")) {
                VLog.d("gctect", "invoke proxy " + method.getName());
            }
    ...
    public void dumpMethodProxies1() {
        StringBuilder sb = new StringBuilder(50);
        sb.append("*********************");
        for (Method proxy : this.getBaseInterface().getClass().getDeclaredMethods()) {
            sb.append(proxy.getName()).append("\n");
        }
        sb.append("*********************");
        VLog.e(TAG, sb.toString());
    }
