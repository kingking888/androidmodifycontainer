...
import mirror.com.android.internal.telephony.ITelephonySub;

/**
 * @author Lody
 */
@Inject(MethodProxiesSub.class)
public class TelephonySubStub extends BinderInvocationProxy {

	public TelephonySubStub() {
		super(ITelephonySub.Stub.asInterface, Context.TELEPHONY_SUBSCRIPTION_SERVICE);
	}
