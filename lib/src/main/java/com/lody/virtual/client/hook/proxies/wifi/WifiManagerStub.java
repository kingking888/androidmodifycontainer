...
//                mirror.android.net.wifi.WifiInfo.mBSSID.set(wifiInfo, getDeviceInfo().bssid);
//
////                mirror.android.net.wifi.WifiInfo.mSSID
//
//            VLog.d("wifihook",getDeviceInfo().ssid);
////                mirror.android.net.wifi.WifiInfo.mSSID.set(getDeviceInfo().ssid);
//                mirror.android.net.wifi.WifiInfo.mMacAddress.set(wifiInfo, "00:00:00:00:00:00");
            ...
            mirror.android.net.wifi.WifiInfo.mWifiSsid.set(wifiInfo, WifiSsid.createFromAsciiEncoded.call(getDeviceInfo().ssid));
//            }
//            if (VASettings.Wifi.FAKE_WIFI_STATE) {
//                return this.createWifiInfo();
//            }
//            if (wifiInfo != null) {
...
//            }
        ...
        private  WifiInfo createWifiInfo() throws Exception {
            ...
            mirror.android.net.wifi.WifiInfo.mBSSID.set(info, getDeviceInfo().bssid);
            mirror.android.net.wifi.WifiInfo.mMacAddress.set(info, getDeviceInfo().wifiMac);
            mirror.android.net.wifi.WifiInfo.mIpAddress.set(info, address);
            mirror.android.net.wifi.WifiInfo.mLinkSpeed.set(info, 65);


//                mirror.android.net.wifi.WifiInfo.mSSID.set(info,WifiSsid.createFromAsciiEncoded.call(getDeviceInfo().ssid)+"");



//            RandomUitls1 r = new RandomUitls1();
...
//                mirror.android.net.wifi.WifiInfo.mWifiSsid.set(info, WifiSsid.createFromAsciiEncoded.call(r.wifiName()));
//            } else {
                mirror.android.net.wifi.WifiInfo.mWifiSsid.set(info, WifiSsid.createFromAsciiEncoded.call(getDeviceInfo().ssid));


            VLog.d("gctech","wifimac:"+mirror.android.net.wifi.WifiInfo.mMacAddress.get(info));
//            mirror.android.net.wifi.WifiInfo.setSSID.call(info,getDeviceInfo().ssid);
//            }

//            VLog.d("gctech","set ssid:"+getDeviceInfo().ssid);
            return info;
        }
    }
