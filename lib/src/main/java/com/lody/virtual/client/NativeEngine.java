...
public class NativeEngine {
    ...
    public static void redirectDirectory(String origPath, String newPath) {
        ...
        Log.d("hook","origPath:"+origPath+",newPath:"+newPath);
        try {
    ...
    public static void redirectDirectoryNO(String origPath, String newPath) {
...
//    public static native void hookcpuinfo(String cpuinfo);


    public static native String getSerious();
    ...
    public static native void hookProperty(Object map);

    public static native void addMap(String key,String val);
