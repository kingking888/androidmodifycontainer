...
//            ServiceManagerNative.SERVICE_CP_AUTH = context.getPackageName() + "." + ServiceManagerNative.SERVICE_DEF_AUTH;
            ...
            VASettings.STUB_CP_AUTHORITY = context.getPackageName() + "." + VASettings.STUB_DEF_AUTHORITY;
            ServiceManagerNative.SERVICE_CP_AUTH = context.getPackageName() + "." + ServiceManagerNative.SERVICE_DEF_AUTH;
//            VLog.d("gctech","VASettings.STUB_CP_AUTHORITY:"+VASettings.STUB_CP_AUTHORITY+",ServiceManagerNative.SERVICE_CP_AUTH:"+ServiceManagerNative.SERVICE_CP_AUTH);
...
//    public Thread mSetAndroidThread = null;
    public void initialize(VirtualInitializer initializer) {
        if (initializer == null) {
            throw new IllegalStateException("Initializer = NULL");
        }

//        if(mSetAndroidThread==null)
//        {
//            mSetAndroidThread =  new Thread(new Runnable() {
//                @Override
//                public void run() {
//
...
//                        }
//
////                        map.put("bluetooth_address","02:00:00:00:00:00");
//
//                        SystemClock.sleep(1);
//                    }
//                }
