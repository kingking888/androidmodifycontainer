 ...
 * <b>XML attributes</b>
 * <p>
 * See {@link com.gc.R.styleable#CardStackLayout CardStackLayout Attributes}
 * <p>
 * {@link com.gc.R.styleable#CardStackLayout_showInitAnimation}
 * {@link com.gc.R.styleable#CardStackLayout_card_gap}
 * {@link com.gc.R.styleable#CardStackLayout_card_gap_bottom}
 * {@link com.gc.R.styleable#CardStackLayout_parallax_enabled}
 * {@link com.gc.R.styleable#CardStackLayout_parallax_scale}
 */
public class CardStackLayout extends FrameLayout {
	...
	private void handleArgs(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
		...
		final TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.gc.R.styleable.CardStackLayout, defStyleAttr,
				defStyleRes);
		mParallaxEnabled = a.getBoolean(com.gc.R.styleable.CardStackLayout_parallax_enabled, PARALLAX_ENABLED_DEFAULT);
		mShowInitAnimation = a.getBoolean(com.gc.R.styleable.CardStackLayout_showInitAnimation, SHOW_INIT_ANIMATION_DEFAULT);
		mParallaxScale = a.getInteger(com.gc.R.styleable.CardStackLayout_parallax_scale,
				getResources().getInteger(com.gc.R.integer.parallax_scale_default));
		mCardGap = a.getDimension(com.gc.R.styleable.CardStackLayout_card_gap, getResources().getDimension(com.gc.R.dimen.card_gap));
		mCardGapBottom = a.getDimension(com.gc.R.styleable.CardStackLayout_card_gap_bottom,
				getResources().getDimension(com.gc.R.dimen.card_gap_bottom));
