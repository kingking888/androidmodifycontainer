...
public class LabelView extends View {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.gc.R.styleable.LabelView);
        mTextContent = ta.getString(com.gc.R.styleable.LabelView_lv_text);
        mTextColor = ta.getColor(com.gc.R.styleable.LabelView_lv_text_color, Color.parseColor("#ffffff"));
        mTextSize = ta.getDimension(com.gc.R.styleable.LabelView_lv_text_size, sp2px(11));
        mTextBold = ta.getBoolean(com.gc.R.styleable.LabelView_lv_text_bold, true);
        mTextAllCaps = ta.getBoolean(com.gc.R.styleable.LabelView_lv_text_all_caps, true);
        mFillTriangle = ta.getBoolean(com.gc.R.styleable.LabelView_lv_fill_triangle, false);
        mBackgroundColor = ta.getColor(com.gc.R.styleable.LabelView_lv_background_color, Color.parseColor("#FF4081"));
        mMinSize = ta.getDimension(com.gc.R.styleable.LabelView_lv_min_size, mFillTriangle ? dp2px(35) : dp2px(50));
        mPadding = ta.getDimension(com.gc.R.styleable.LabelView_lv_padding, dp2px(3.5f));
        mGravity = ta.getInt(com.gc.R.styleable.LabelView_lv_gravity, Gravity.TOP | Gravity.LEFT);
        ta.recycle();
    }
