...
public abstract class CardStackAdapter implements View.OnTouchListener, View.OnClickListener {
	...
	public CardStackAdapter(Context context) {
		...
		dp30 = (int) resources.getDimension(com.gc.R.dimen.dp30);
		scaleFactorForElasticEffect = (int) resources.getDimension(com.gc.R.dimen.dp8);
		dp8 = (int) resources.getDimension(com.gc.R.dimen.dp8);
	}
	...
	void addView(final int position) {
		...
		root.setTag(com.gc.R.id.cardstack_internal_position_tag, position);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		int positionOfCardToMove = (int) v.getTag(com.gc.R.id.cardstack_internal_position_tag);
	...
	public void onClick(final View v) {
		...
		setScreenTouchable(false);
		if (mSelectedCardPosition == INVALID_CARD_POSITION) {
			mSelectedCardPosition = (int) v.getTag(com.gc.R.id.cardstack_internal_position_tag);
