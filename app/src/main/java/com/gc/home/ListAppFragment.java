...
import com.gc.XApp;
import com.gc.abs.ui.VFragment;
import com.gc.home.adapters.CloneAppListAdapter;
import com.gc.home.models.AppInfo;
import com.gc.home.models.AppInfoLite;
import com.gc.sys.Installd;
import com.gc.widgets.DragSelectRecyclerView;
...
public class ListAppFragment extends VFragment<ListAppContract.ListAppPresenter> implements ListAppContract.ListAppView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.gc.R.layout.fragment_list_app, null);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        mRecyclerView = (DragSelectRecyclerView) view.findViewById(com.gc.R.id.select_app_recycler_view);
        mProgressBar = (ProgressBar) view.findViewById(com.gc.R.id.select_app_progress_bar);
        mInstallButton = (Button) view.findViewById(com.gc.R.id.select_app_install_btn);
        mSelectFromExternal = view.findViewById(com.gc.R.id.select_app_from_external);
        ...
        mAdapter.setOnItemClickListener(new CloneAppListAdapter.ItemEventListener() {
            ...
            public void onItemClick(AppInfo info, int position) {
                ...
                if (!mAdapter.isIndexSelected(position)) {
                    if (count >= 9) {
                        Toast.makeText(getContext(), com.gc.R.string.install_too_much_once_time, Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
        ...
        mAdapter.setSelectionListener(count -> {
            ...
            mInstallButton.setText(String.format(Locale.ENGLISH, XApp.getApp().getResources().getString(com.gc.R.string.install_d), count));
        });
