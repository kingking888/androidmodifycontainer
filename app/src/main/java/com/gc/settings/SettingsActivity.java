...
import com.gc.home.ListAppActivity;
...
public class SettingsActivity extends Activity {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            addPreferencesFromResource(com.gc.R.xml.settings_preferences);
...
//            Preference about = findPreference(ABOUT_KEY);
            ...
            Preference start = findPreference("settings_start");

            Preference back = findPreference("settings_back");

            start.setOnPreferenceClickListener(preference -> {
                GCLogic.get().newDevices();
                Toast.makeText(getActivity(), "new device succes", Toast.LENGTH_SHORT).show();
                return false;
            });
...
//            });
            ...
            reboot.setOnPreferenceClickListener(preference -> {
                ...
                TelephonyManager tel = (TelephonyManager) SettingsFragment.this.getActivity().getSystemService(Context.TELEPHONY_SERVICE);
                android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(getActivity())
                        .setTitle(tel.getDeviceId())
                        .setMessage(getResources().getString(com.gc.R.string.settings_reboot_content))
                        .setPositiveButton(android.R.string.yes, (dialog, which) -> {
                            VirtualCore.get().killAllApps();
                            Toast.makeText(getActivity(), com.gc.R.string.reboot_tips_1, Toast.LENGTH_SHORT).show();
                        })
            ...
            copyFile.setOnPreferenceClickListener((preference -> {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(getActivity(), com.gc.R.style.Theme_AppCompat_DayNight_Dialog_Alert)
                        .setTitle(com.gc.R.string.advance_settings_copy_file)
                        .setView(layout)
