...
import com.gc.update.VAVersionService;
...
//                .addGitHub("tiann");
    ...
    Element getFeedbackQQElement() {
        ...
        final String qqGroup = "3116964524";
    ...
    Element getFeedbackEmailElement() {
        ...
        final String email = "3116964524@qq.com";
    ...
    Element getCheckUpdateElement() {
        TelephonyManager tel = (TelephonyManager) AboutActivity.this.getSystemService(Context.TELEPHONY_SERVICE);


        Element checkUpdate = new Element();
        checkUpdate.setTitle(tel.getDeviceId());
