...
public class RecommendPluginActivity extends VActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ListView mListView = findViewById(com.gc.R.id.list);
        mAdapter = new PluginAdapter();
        mListView.setAdapter(mAdapter);
        mListView.setEmptyView(findViewById(com.gc.R.id.empty_view));
    ...
    static class ViewHolder {
        ...
        public ViewHolder(Context context, ViewGroup parent) {
            root = LayoutInflater.from(context).inflate(com.gc.R.layout.item_plugin_recommend, parent, false);
            title = root.findViewById(com.gc.R.id.item_plugin_name);
            summary = root.findViewById(com.gc.R.id.item_plugin_summary);
        }
    }
